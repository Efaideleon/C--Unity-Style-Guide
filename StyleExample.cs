...
namespace UnityCSharpStyleSheetExample
{
    ...
    public class StyleExample : MonoBehaviour
    {
        ...
        // | Treat internal variables like public variables, use PascalCase for both.
        // | Specify the default private access modifier. 
        ...
        // Private static fields should be camelCase
        ...
        [Serializable] private PlayerStats _stats;
        ...
        // Example for initializing target-type.
        private List<int> _tartegTypeExample;

        // Initializing a field, specify both type and tartget-type
        private List<int> _aClassField = new List<int>();
        ...
        private void FormatExamples(int someExpression)
        {
            ...
            // | In foreach loops, var ensures that the iteraction variable matches the type provided by the enumerator. 
            ...
            // Favor explicit target-type over inferred to make it more clear.
            _tartegTypeExample = new List<int>();

            // Avoid var when the type comes from a method call. 
            ExampleReturnType example = GetExampleReturnType();
        ...
        private ExampleReturnType GetExampleReturnType() => new ExampleReturnType(); 
    }
